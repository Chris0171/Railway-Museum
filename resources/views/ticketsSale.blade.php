...
<div class="row justify-content-center">
    <div class="col-12 col-md-10 text-center mt-4">
        ...
        <hr class="mt-4 border border-dark border-3">
    </div>
</div>
...
<form action="" method="post">
    ...
    <div class="row justify-content-center align-items-center" style="display: flex;">
        <div class="col-10 col-md-6 mt-5">
            <div class="card border-secondary border-3 mb-3">
                    ...
                    <div class="row g-3 justify-content-center pe-5 ps-5 align-items-center">
                        ...
                        <div class="col-auto p-0">
                            <div class="form-check">
                                ...
                                <label class="btn border-dark border-2 btn-outline-dark fw-bold rounded-4"
                                    for="franja1">Franja
                                    1</label>
                            </div>
                        </div>
                ...
                <div class="card-footer bg-light text-end p-3 ps-5 pe-5 ">
                    <div class="row">
                        <div class="col-auto ms-auto">
                            <button type="button" class="btn btn-success fw-bold">Siguiente</button>
                        </div>
                    </div>
                </div>
            </div>
